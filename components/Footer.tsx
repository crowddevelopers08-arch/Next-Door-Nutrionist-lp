        ...
        <div className="space-y-5 sm:col-span-2 md:col-span-1">
          ...
          <div className="flex gap-3 pt-1">
            ...
            <a
              ...
              className="flex h-9 w-9 items-center justify-center rounded-full border border-[#B7D29B40] text-[#B7D29B] transition-colors hover:border-[#B7D29B] hover:bg-[#B7D29B20]"
            >

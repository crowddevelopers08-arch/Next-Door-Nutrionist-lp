      ...
      >
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 lg:p-10 w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl mx-auto">
          ...
          <div className="text-center mb-6 sm:mb-8 lg:mb-10">
            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-[#0B4A35] mb-3 sm:mb-4">
              Click &amp; Review
            </h2>
          ...
          <div className="flex flex-col gap-3 sm:gap-4 lg:gap-5">
            <a href="https://g.page/r/CeVzC4gxJ2NtEBM/review" target="_blank" rel="noopener noreferrer">
              <button
                ...
                style={{ backgroundColor: '#0B4A35' }}
                onMouseEnter={e => (e.currentTarget.style.backgroundColor = '#093c2a')}
                onMouseLeave={e => (e.currentTarget.style.backgroundColor = '#0B4A35')}
              >
                Client Review
              </button>
            </a>
            <a href="/client-feedback">
              <button
                ...
                style={{ borderColor: '#0B4A35', color: '#0B4A35' }}
                onMouseEnter={e => {
                  e.currentTarget.style.backgroundColor = '#0B4A35';
                  e.currentTarget.style.color = '#ffffff';
                }}
                onMouseLeave={e => {
                  e.currentTarget.style.backgroundColor = 'transparent';
                  e.currentTarget.style.color = '#0B4A35';
                }}
              >
                Client Feedback
              </button>
